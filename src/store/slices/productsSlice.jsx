...
export const getProductsThunk = () => (dispatch) => {
  ...
  axios
    .get("https://backend-api-ecommerce-7wn7.onrender.com/products")
...
export const filteredProductsByCategoryThunk = (id) => (dispatch) => {
  dispatch(setIsLoading(true))
  axios
    .get(`https://backend-api-ecommerce-7wn7.onrender.com/products/category_id/${id}`)
...
export const filteredProductsByNameThunk = (title) => (dispatch) => {
  ...
  axios
    .post("https://backend-api-ecommerce-7wn7.onrender.com/products/name",body)
    .then((res) => {
